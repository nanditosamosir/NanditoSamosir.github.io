  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-3xl px-6">
        ...
        */}
        <img
          src="https://drive.google.com/file/d/1tzXorw7H--FWPH3w_HoGwQgbnoc60LBT/view?usp=drive_link"
        ...
        <p className="mt-4 text-lg md:text-xl text-stone-200">
          A dedicated and results-oriented fresh graduate of Computer
          Engineering, passionate about Embedded Systems, Data Analysis, and
          Machine Learning.
        </p>
        ...
        <div className="mt-6 flex justify-center space-x-6">
          <a
            href="https://github.com/nanditosamosir"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/nanditosamosir/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-stone-300 hover:text-amber-400 transition-colors duration-300"
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="https://drive.google.com/file/d/1C0rt7orTNHtS0w6FDjyUE6b2dqeqmpXb/view?usp=sharing"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-amber-600 text-white font-semibold py-3 px-8 rounded-full hover:bg-amber-700 transition-all duration-300 shadow-lg shadow-amber-500/20 w-full sm:w-auto justify-center"
          >
          ...
          <a
            href="#contact"
            className="bg-stone-200 text-stone-900 font-semibold py-3 px-8 rounded-full hover:bg-stone-300 transition-all duration-300 w-full sm:w-auto"
          >
            Contact Me
          </a>
        </div>
